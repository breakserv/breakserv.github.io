...
echo '<body id="page-top" class="index">
    ...
    <pre id="output" hidden></pre>';
                    ...
                    if ($row[isFree] == 1) {
                        echo '<BR><BR><BR><h4 class="text-muted">WARNING.</h4><h3 class="section-subheading text-muted">As a free user, you are only able to store up to 5 events.<BR>Scraping will not overwrite any of your current events.<BR>If you have hit the max, please register for Premium or delete events to make space.<BR><BR><BR><BR>Currently, you have '.$row[CurrCount].' events stored with us. </h3>';
                    } else {
