...
<?php
      ...
      echo '<br><br><br><br><br><center><h1><b><i>Deleting event(s) now...</h1></center>';

      include ("connectDb.php");

      // Delete everything if the user requests it.
      if (strcmp($eventID, "ALL") == 0) {
            $sql2 = "DELETE FROM Events WHERE eUser='$user' ";
            $result2 = mysql_query($sql2);

            // Re-update the currCount to be 0
